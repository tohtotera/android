...
public class Landmarks extends MapActivity {
	...
	Object[][] landmarks = {
		{"�����^���[", new GeoPoint(35658610, 139745447), false},
		{"���l�����h�}�[�N�^���[", new GeoPoint(35454559, 139631373), false},
		{"�ʓV�t", new GeoPoint(34652553, 135506333), false},
		{"�����^���[", new GeoPoint(33593313, 130351478), false},
	};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mark.setBounds(0, 0, mark.getMinimumWidth(), mark.getMinimumHeight()); // ������s��Ȃ��ƕ\������Ȃ�
